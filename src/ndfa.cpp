...
//         accumulator.jumps.back() = state_jumps1;
//         accumulator.jumps.insert(accumulator.jumps.end(), current.jumps.begin() + 1,
//                                  current.jumps.end());
// //         state_jumps1 = a1.jumps.back();
// //         state_jumps2 = a2.jumps[0];
// //         for(auto sj : state_jumps2){
...
// generate_NDFA_for_command(NDFA&  a,       const  Unwrapped_commands& commands,
//                           size_t cmd_nom, size_t first_state_nom
